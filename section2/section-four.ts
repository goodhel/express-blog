...
function result4(reports: Reports) {
  // Make object to array pair [key, value]
  const arr = Object.entries(reports)

  // Temporary array
  const data = []

  // Looping for assign first value of array to date and
  // second one to profit
